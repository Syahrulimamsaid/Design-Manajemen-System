...
import { commentCustomer, getDashboard, topDesigner } from '../../Helpers/API/DashboardAPI';
...
import ChartCS from '../../layout/Dashboard/Chart/ChartCS';
import ChartQC from '../../layout/Dashboard/Chart/ChartQC';
import ListCommentQC from '../../layout/Dashboard/List/ListCommentQC';

const DashboardQC: React.FC = () => {
  interface DashboardQCData {
    belum_dicek: number;
    acc: number;
    rejec: number;
  }

  const [dataDash, setDataDash] = useState<DashboardQCData | null>(null);
            ...
            <div className="gap-5 grid grid-cols-1">
              <CardDataStats
                ...
                total={
                  dataDash != null
                    ? dataDash !== undefined
                      ? dataDash.belum_dicek.toString() ?? '0'
                      : '0'
                    : '0'
                }
                note="Di Bulan Ini"
