...
import ListDesigner from '../../layout/Dashboard/List/ListDesigner';
import ChartDesigner from '../../layout/Dashboard/Chart/ChartDesigner';

const DashboardDesigner: React.FC = () => {
  interface DashboardDesignerData {
    total_job: number;
  ...
  const [dataDash, setDataDash] = useState<DashboardDesignerData | null>(null);
        ...
        <div className="gap-5 grid grid-cols-2">
          ...
          <CardDataStats
            ...
            total={
              dataDash != null
                ? dataDash !== undefined
                  ? dataDash.on_progress.toString() ?? '0'
                  : '0'
                : '0'
            }
            note="Di Bulan Ini"
